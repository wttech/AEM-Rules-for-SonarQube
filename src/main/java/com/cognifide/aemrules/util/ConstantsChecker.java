...
public class ConstantsChecker {
	...
	static {
		...
		ANNOTATION_CONSTANTS = ImmutableMap.<String, String>builder()
				...
				.put("org/apache/sling/api/resource/ResourceResolverMapping/CHANGED", "TOPIC_RESOURCE_RESOLVER_MAPPING_CHANGED from class org.apache.sling.api.SlingConstants")
