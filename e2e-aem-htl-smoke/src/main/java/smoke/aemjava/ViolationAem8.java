...
// Pattern from wttech/.../src/test/files/java/SlingServletOne.java (PreferSlingServletAnnotationTest).
...
public class ViolationAem8 extends SlingSafeMethodsServlet {
